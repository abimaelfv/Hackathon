...
<template>
    ...
    <GuestLayout>
        <div class="mb-4 text-sm text-gray-600">
            <p>
                <b class="text-udh_3">¡Gracias por registrarte!</b>
                Para comenzar verifica tu dirección de correo electrónico.
            </p>
            <p class="d-block pt-3">
                Por favor,
                <b class="text-udh_3">revisa tu bandeja de entrada</b> y haz
                clic en el enlace de verificación que te hemos enviado al correo
                <b class="text-udh_3 font-bold">{{ $page.props.auth.user.email }}</b>. Si no encuentras el
